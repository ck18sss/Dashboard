...
var Layout = /** @class */ (function () {
    ...
    Layout.prototype.layoutItems = function (sections, isReLayout, isContinuousSection) {
        ...
        for (var i = 0; i < sections.length; i++) {
            ...
            if (i > 0 && !isNullOrUndefined(sections[i - 1].lastChild) && !(sections[i - 1].lastChild instanceof TableWidget) && (sections[i - 1].lastChild.isEndsWithPageBreak || sections[i - 1].lastChild.isEndsWithColumnBreak) && lastpage.bodyWidgets[0].childWidgets.length === 0) {
   ...
   */
    ...
    Layout.prototype.layoutElement = function (element, paragraph, isEmptyField) {
        ...
        if (text === '\r') {
            ...
            var newline = new LineWidget(newParagraph);
            newParagraph.childWidgets.push(newline);
            do {
                var lastElement = line.children[line.children.length - 1];
                if (lastElement === element) {
                    break;
                }
