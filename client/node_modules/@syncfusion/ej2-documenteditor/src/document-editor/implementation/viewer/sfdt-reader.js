    ...
    SfdtReader.prototype.parseStyle = function (data, style, styles, resetKeyIndex) {
        ...
        if (!isNullOrUndefined(style[typeProperty[this.keywordIndex]])) {
            ...
            if (!isNullOrUndefined(style[basedOnProperty[this.keywordIndex]])) {
                var basedOn = styles.findByName(style[basedOnProperty[this.keywordIndex]]);
            ...
            if (!isNullOrUndefined(style[nextProperty[this.keywordIndex]])) {
                if (style[nextProperty[this.keywordIndex]] === style[nameProperty[this.keywordIndex]]) {
                    ...
                    var next = styles.findByName(style[nextProperty[this.keywordIndex]]);
            ...
            if (inline.hasOwnProperty(textProperty[this.keywordIndex]) || inline.hasOwnProperty(breakClearTypeProperty[this.keywordIndex])) {
                ...
                if (inline.hasOwnProperty(formFieldDataProperty[this.keywordIndex])) {
                    ...
                    if (inline[formFieldDataProperty[this.keywordIndex]].hasOwnProperty(textInputProperty[this.keywordIndex])) {
                        ...
                        formFieldData.type = this.getTextFormFieldType(inline[formFieldDataProperty[this.keywordIndex]][textInputProperty[this.keywordIndex]][typeProperty[this.keywordIndex]]);
                        formFieldData.maxLength = inline[formFieldDataProperty[this.keywordIndex]][textInputProperty[this.keywordIndex]][maxLengthProperty[this.keywordIndex]];
                        formFieldData.defaultValue = inline[formFieldDataProperty[this.keywordIndex]][textInputProperty[this.keywordIndex]][defaultValueProperty[this.keywordIndex]];
                        formFieldData.format = this.getTextFormFieldFormat(inline[formFieldDataProperty[this.keywordIndex]][textInputProperty[this.keywordIndex]][formatProperty[this.keywordIndex]]);
                    }
                        ...
                        formFieldData.sizeType = this.getCheckBoxSizeType(inline[formFieldDataProperty[this.keywordIndex]][checkBoxProperty[this.keywordIndex]][sizeTypeProperty[this.keywordIndex]]);
                        formFieldData.size = inline[formFieldDataProperty[this.keywordIndex]][checkBoxProperty[this.keywordIndex]][sizeProperty[this.keywordIndex]];
                        formFieldData.defaultValue = HelperMethods.parseBoolValue(inline[formFieldDataProperty[this.keywordIndex]][checkBoxProperty[this.keywordIndex]][defaultValueProperty[this.keywordIndex]]);
                        formFieldData.checked = HelperMethods.parseBoolValue(inline[formFieldDataProperty[this.keywordIndex]][checkBoxProperty[this.keywordIndex]][checkedProperty[this.keywordIndex]]);
                    }
                    else {
                        formFieldData = new DropDownFormField();
                        formFieldData.dropdownItems = inline[formFieldDataProperty[this.keywordIndex]][dropDownListProperty[this.keywordIndex]][dropDownItemsProperty[this.keywordIndex]];
                        formFieldData.selectedIndex = inline[formFieldDataProperty[this.keywordIndex]][dropDownListProperty[this.keywordIndex]][selectedIndexProperty[this.keywordIndex]];
                    }
