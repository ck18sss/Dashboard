...
import { Card, Title, Bold, Flex, Text, BarList } from "@tremor/react";
    ...
    const data = [
      ...
      return (
        <ThemeProvider theme={darkTheme}>
          <div className="dark:bg-dark-tremor-background-900 dark:text-dark-tremor-content-subtle border-gray-800">
            <div className="bg-dark-tremor-background-900 text-black p-4 rounded-lg shadow-lg dark:bg-dark-tremor-background-muted dark:text-dark-tremor-content-subtle">
              <Card className= "border-gray-800 bg-tremor-ring-900" decoration="bottom" decorationColor="gray"> 
